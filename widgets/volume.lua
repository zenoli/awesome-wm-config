...
function volume:inc() spawn.easy_async_with_shell(INC_VOLUME_CMD, alsa.update) end
function volume:dec() spawn.easy_async_with_shell(DEC_VOLUME_CMD, alsa.update) end
function volume:toggle() spawn.easy_async_with_shell(TOG_VOLUME_CMD, alsa.update) end

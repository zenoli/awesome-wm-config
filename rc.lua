...
local freedesktop       = require("submodules.freedesktop")
...
globalkeys = mytable.join(
    ...
    -- awful.key({ }, "XF86MonBrightnessUp", function () os.execute("sudo $HOME/.config/zsh/scripts/adjust_brightness.bash -inc 5") end,
    --           {description = "+10%", group = "hotkeys"}),
    -- awful.key({ }, "XF86MonBrightnessDown", function () os.execute("sudo $HOME/.config/zsh/scripts/adjust_brightness.bash -dec 5") end,
    --           {description = "-10%", group = "hotkeys"}),
    ...
    awful.key({ altkey }, "b", function () awful.util.spawn("qb_launcher") end,
              {description = "run htop", group = "launcher"}),
...
add_tag_bindings(m_tag_ids.tag_1,"#" .. 1 + 9, "1")
add_tag_bindings(m_tag_ids.tag_2,"#" .. 2 + 9, "2")
add_tag_bindings(m_tag_ids.tag_3,"#" .. 3 + 9, "3")
